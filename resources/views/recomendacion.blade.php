            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{route('vista-recomendacion')}}">Recomendacion</a>
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="card mb-4">
                                <div class="card-header">
                                    Modificar la pelicula recomendada
                                </div>
                                <div class="card-body">
                                   ...
                                   <form action="#">
                                    ...
                                    <div class="mb-4">
                                        <img class="img-fluid  mx-auto d-block" width="200px" src="redsocialPortada.jpg" alt="portada">
                                          <div class="custom-file mb-2 mt-2">
                                            <select name="movie" id="movie">
                                                <option value="x">La red social</option>
                                                <option value="x">Matrix</option>
                                                <option value="x">soy leyenda</option>
                                            </select>
                                            <div class="input-group-prepend">
                                                <span class="">Actualizar trailer</span>
                                            </div>
                                              <div class="custom-file mb-2 mt-2">
                                        ...
                                        <input type="submit" class="btn btn-primary mt-4" value="Actualizar">
                                    </form>
